...
feature_text: |
  ...
  A hands on approach on solving a supervised anomaly detection problem !
image: "https://cdn.pixabay.com/photo/2020/11/30/16/42/great-white-pelicans-5791392_1280.jpg"
tags: MachineLearning XGBoost SupervisedLearning Kaggle
comments: true
---
...
{% include figure.html image="/assets/img/kaggle_ml/competition_pipelin.png" caption="Figure 1: Summary pipeline breakdown" position="center"%}
...
{% include figure.html image="/assets/img/kaggle_ml/pca_pre_ps.png" caption="Figure 2: Normalized PCA reduction to 3 features of the whole dataset" position="center" %}
...
{% include figure.html image="/assets/img/kaggle_ml/tsne.png" caption="Figure 3: Normalized t-SNE reduction in 2 dimension of the whole dataset"%}
...
{% include figure.html image="/assets/img/kaggle_ml/error_vs_threshold.png" caption="Figure 4: Loss vs threshold selection on feature reduction"%}
...
{% include figure.html image="/assets/img/kaggle_ml/feature_reduction.png" caption="Figure 5: Best Feature Reduction"%}
...
{% include figure.html image="/assets/img/kaggle_ml/feature_importances.png" caption="Figure 6: Feature importances by the XGBoost
" class="center"%}
